...
-- Schema printee
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `printee`;

CREATE SCHEMA `printee`;
USE `printee` ;

-- -----------------------------------------------------
-- Table `printee`.`product_category`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `printee`.`product` (
  ...
  CONSTRAINT `category` FOREIGN KEY (`category_id`) REFERENCES `product_category` (`id`)
) 
ENGINE=InnoDB
AUTO_INCREMENT = 1;
